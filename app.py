...
app.layout = html.Div([
    # header
    html.Div([
        html.Span("Air pollution web app - COVID 19 Project",
                  className='app-title'),
        html.Div(html.Img(
            src=
            'https://wwwfr.uni.lu/var/storage/images/universite/actualites/a_la_une/collaboration_scellee_avec_liser/1014145-1-fre-FR/collaboration_scellee_avec_liser_medium.jpg',
            height="100%"),
                 style={
                     "float": "right",
                     "height": "100%"
            ...
            html.Div([
                ...
                dcc.RadioItems(id='crossfilter-yaxis-type',
                               options=[{
                                   ...
                                   'COVID-19 deaths', 'COVID-19 cases',
                                   'COVID-19 hotspots'
                               ]],
            ...
            html.Div([
                ...
                dcc.RadioItems(
                    ...
                    options=[{
                        'label': i,
                        'value': i
                    } for i in ['Air pollution', 'wheather', 'land use']],
                    value='Air pollution',
                    labelStyle={'display': 'inline-block'})
            ],
                     style={
            ...
            html.Div([
                ...
                dcc.RadioItems(
                    ...
                    options=[{
                        'label': i,
                        'value': i
                    } for i in ['Demography', 'Socio economic', 'Density']],
                    value='Demography',
                    labelStyle={'display': 'inline-block'})
            ],
                     style={
    ...
    html.Div([dcc.Graph(id='pollution_map', style={"height": 700},
                        figure={})]),
    html.Div(dcc.Slider(id='month_selector',
                        min=1,
                        max=12,
                        value=1,
                        marks={
...
def update_graph(reg, poll, nut, y, m, s):
    gdf = pd.read_excel(('./data/processedData/{}_{}_{}_{}_{}.xlsx').format(
        reg, poll, nut, y, m))
