...
app.layout = html.Div(
    [
        ...
        html.Div([
            ...
            html.Div(
                html.Img(src='https://wwwfr.uni.lu/var/storage/images/universite/actualites/a_la_une/collaboration_scellee_avec_liser/1014145-1-fre-FR/collaboration_scellee_avec_liser_medium.jpg', height="100%"), style={"float": "right", "height": "100%"})
        ],
            ...
            html.Div([
                ...
                dcc.RadioItems(
                    ...
                    options=[{'label': i, 'value': i} for i in [
                        'COVID-19 deaths', 'COVID-19 cases', 'COVID-19 hotspots']],
